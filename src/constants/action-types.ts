...
export type MAP_CHECK = typeof MAP_CHECK;
...
export const LAYER_VIZ_SET = 'LAYER_VIZ_SET';
export type LAYER_VIZ_SET = typeof LAYER_VIZ_SET;
export const LAYER_ADD = 'LAYER_ADD';
export type LAYER_ADD = typeof LAYER_ADD;
export const LAYER_REMOVE = 'LAYER_REMOVE';
export type LAYER_REMOVE = typeof LAYER_REMOVE;

export const STYLE_SET = 'STYLE_SET';
export type STYLE_SET = typeof STYLE_SET;
 ...
 * Map Draw Control
 */
export const DRAW_TOGGLE = 'DRAW_TOGGLE';
